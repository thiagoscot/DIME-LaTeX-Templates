...
\begin{frame}
	...
	\includegraphics[scale=0.25]{img/wbg.png} \qquad
	\includegraphics[scale=0.25]{img/i2i.png} 
\end{frame}
...
\begin{textblock*}{100mm}(.5\textwidth,8cm)
		\includegraphics[height=0.5cm,width=1cm]{img/i2i.png}
\end{textblock*}}
...
\begin{figure}
	\centering
	\includegraphics[scale = 0.5]{img/howdoestexwork.png}
\end{figure}
}
\frame{
...
\frame{
	...
	\begin{figure}
		\centering
		\includegraphics[scale=0.5]{img/preamble.png}
	\end{figure}
}
...
\begin{frame}[fragile]
	...
	\begin{figure}
		\centering
		\includegraphics[width=1\linewidth]{img/header}
	\end{figure}
	\begin{multicols}{2}
		[]
	\begin{description}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth]{img/preamble12}
	\end{figure}
...
\begin{frame}[fragile]
	...
	\begin{figure}
		\includegraphics[width=0.7\linewidth]{img/sections1}
	\end{figure}
 \begin{figure}
 	\centering
 	\includegraphics[width=0.7\linewidth]{img/sections2}
 \end{figure}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\linewidth]{img/writing}
	\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{img/writing1}
\end{figure}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{figure}
		\includegraphics[width=0.7\linewidth]{img/import}
	\end{figure}
\begin{itemize}
	\tiny
...
\begin{frame}[fragile]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\linewidth]{img/import1}
	\end{figure}
	\begin{itemize}
		\tiny
...
\begin{frame}[fragile]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\linewidth]{img/fragm}
	\end{figure}
\begin{itemize}
